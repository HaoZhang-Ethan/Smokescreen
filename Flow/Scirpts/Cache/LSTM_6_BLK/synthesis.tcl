...
# LSTM_6_BLK.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug LSTM_6_BLK.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches LSTM_6_BLK.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/memory_pim.v

#(/root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Scirpts/Cache/LSTM_6_BLK/dpram_rename.v
...
# LSTM_6_BLK.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox LSTM_6_BLK.yosys.blif

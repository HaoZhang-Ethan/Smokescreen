...
# attention_layer.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug attention_layer.v
	...
	read_systemverilog -debug attention_layer.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches attention_layer.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/Attention/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/Attention/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/Attention/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/Attention/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/Attention/dpram_rename.v
...
# attention_layer.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox attention_layer.yosys.blif

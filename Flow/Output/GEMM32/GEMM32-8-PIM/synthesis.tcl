...
# GEMM32_8_PIM.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug GEMM32_8_PIM.v
	...
	read_systemverilog -debug GEMM32_8_PIM.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches GEMM32_8_PIM.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM32-8-PIM/dpram_rename.v
...
# GEMM32_8_PIM.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox GEMM32_8_PIM.yosys.blif

...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Find_OP/1-4-43/dpram_rename.v

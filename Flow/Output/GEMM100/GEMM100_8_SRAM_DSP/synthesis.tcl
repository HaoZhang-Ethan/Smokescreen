...
# GEMM100_8_DSP.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug GEMM100_8_DSP.v
	...
	read_systemverilog -debug GEMM100_8_DSP.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches GEMM100_8_DSP.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/GEMM100/GEMM100_8_SRAM_DSP/dpram_rename.v
...
# GEMM100_8_DSP.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox GEMM100_8_DSP.yosys.blif

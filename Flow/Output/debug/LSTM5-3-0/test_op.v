...
//FORGET GATE
  ...
  vecmat_h_6_CLB vecmat_add_OP_2 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uf_in), .data_out_h(macout_fh));
...
//INPUT GATE
  vecmat_x_6_DSP vecmat_add_OP_3 (.clk(clk), .reset(rst), .data_x(Wi_in), .W_x(Wi_in), .data_out_x(macout_ix));
...
//OUTPUT GATE
  vecmat_x_6_DSP vecmat_add_OP_5 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wo_in), .data_out_x(macout_ox));
  vecmat_h_6_DSP vecmat_add_OP_6 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uo_in), .data_out_h(macout_oh));
...
//CELL STATE GATE
  vecmat_x_6_CLB vecmat_add_OP_7 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wc_in), .data_out_x(macout_cx));

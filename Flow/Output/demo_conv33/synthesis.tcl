...
# conv33_6bit_.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug conv33_6bit_.v
	...
	read_systemverilog -debug conv33_6bit_.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches conv33_6bit_.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/demo_conv33/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/demo_conv33/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/demo_conv33/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/demo_conv33/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/demo_conv33/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/demo_conv33/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/demo_conv33/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/demo_conv33/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/demo_conv33/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/demo_conv33/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/demo_conv33/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/demo_conv33/dpram_rename.v
...
# conv33_6bit_.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox conv33_6bit_.yosys.blif

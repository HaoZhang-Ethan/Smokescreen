...
# lstm8_area.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug lstm8_area.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches lstm8_area.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/lstm8_AREA/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/lstm8_AREA/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/lstm8_AREA/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/lstm8_AREA/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/lstm8_AREA/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/lstm8_AREA/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/lstm8_AREA/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/lstm8_AREA/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/lstm8_AREA/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/lstm8_AREA/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/lstm8_AREA/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/lstm8_AREA/dpram_rename.v
...
# lstm8_area.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox lstm8_area.yosys.blif

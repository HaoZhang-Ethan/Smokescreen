...
//FORGET GATE
  vecmat_x_8 vecmat_add_OP_1 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wf_in), .data_out_x(macout_fx));
  vecmat_h_8 vecmat_add_OP_2 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uf_in), .data_out_h(macout_fh));
...
//INPUT GATE
  vecmat_x_8 vecmat_add_OP_3 (.clk(clk), .reset(rst), .data_x(Wi_in), .W_x(Wi_in), .data_out_x(macout_ix));
  vecmat_h_8 vecmat_add_OP_4 (.clk(clk), .reset(rst), .data_h(Ui_in), .W_h(Ui_in), .data_out_h(macout_ih));
...
//OUTPUT GATE
  vecmat_x_8 vecmat_add_OP_5 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wo_in), .data_out_x(macout_ox));
  vecmat_h_8 vecmat_add_OP_6 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uo_in), .data_out_h(macout_oh));
...
//CELL STATE GATE
  vecmat_x_8 vecmat_add_OP_7 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wc_in), .data_out_x(macout_cx));
  vecmat_h_8 vecmat_add_OP_8 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uc_in), .data_out_h(macout_ch));

...
<<<<<<< HEAD:Flow/Output/LSTM/synthesis.tcl
# vecmat_h_6_CLB.v (input circuit) is replaced with filename by the run_vtr_flow script
=======
# lstm.v (input circuit) is replaced with filename by the run_vtr_flow script
>>>>>>> parent of 88a9848d (update):Flow/Output/lstm/synthesis.tcl
...
<<<<<<< HEAD:Flow/Output/LSTM/synthesis.tcl
	read_uhdm -debug vecmat_h_6_CLB.v
=======
...
<<<<<<< HEAD:Flow/Output/LSTM/synthesis.tcl
	read_systemverilog -debug vecmat_h_6_CLB.v
=======
...
<<<<<<< HEAD:Flow/Output/LSTM/synthesis.tcl
	read_verilog -sv -nolatches vecmat_h_6_CLB.v
=======
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/LSTM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/LSTM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/LSTM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/LSTM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/LSTM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM/dpram_rename.v
...
<<<<<<< HEAD:Flow/Output/LSTM/synthesis.tcl
# vecmat_h_6_CLB.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox vecmat_h_6_CLB.yosys.blif
=======

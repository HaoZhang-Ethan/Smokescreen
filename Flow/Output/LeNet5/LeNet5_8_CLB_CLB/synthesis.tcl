...
# LeNet5_8_CLB.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug LeNet5_8_CLB.v
	...
	read_systemverilog -debug LeNet5_8_CLB.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches LeNet5_8_CLB.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LeNet5/LeNet5_8_CLB_CLB/dpram_rename.v
...
# LeNet5_8_CLB.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox LeNet5_8_CLB.yosys.blif

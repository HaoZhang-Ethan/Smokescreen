...
# attention_layer-8-DSP.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug attention_layer-8-DSP.v
	...
	read_systemverilog -debug attention_layer-8-DSP.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches attention_layer-8-DSP.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Attention/Attention-8-NVM-NVM/dpram_rename.v
...
# attention_layer-8-DSP.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox attention_layer-8-DSP.yosys.blif

...
# conv_top_55.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug conv_top_55.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches conv_top_55.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/PIM/CONV55/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/PIM/CONV55/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/PIM/CONV55/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/PIM/CONV55/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/PIM/CONV55/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/PIM/CONV55/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/PIM/CONV55/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/PIM/CONV55/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/PIM/CONV55/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/PIM/CONV55/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/PIM/CONV55/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/PIM/CONV55/dpram_rename.v
...
# conv_top_55.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox conv_top_55.yosys.blif

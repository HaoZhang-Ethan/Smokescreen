...
//FORGET GATE
  vecmat_x_8_DSP vecmat_add_OP_1 (.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wf_in), .data_out_x(macout_fx));
...
//CELL STATE GATE
  ...
  vecmat_h_8_DSP vecmat_add_OP_8 (.clk(clk), .reset(rst), .data_h(h_in), .W_h(Uc_in), .data_out_h(macout_ch));

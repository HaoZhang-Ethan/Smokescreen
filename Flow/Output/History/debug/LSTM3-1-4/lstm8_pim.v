...
//INPUT GATE
  vecmat_x_8_PIM vecmat_add_OP_3 (.clk(clk), .reset(rst), .data_x(Wi_in), .W_x(Wi_in), .data_out_x(macout_ix));
  vecmat_h_8_PIM vecmat_add_OP_4 (.clk(clk), .reset(rst), .data_h(Ui_in), .W_h(Ui_in), .data_out_h(macout_ih));

...
# test_myop-PIM.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug test_myop-PIM.v
	...
	read_systemverilog -debug test_myop-PIM.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches test_myop-PIM.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN-PIM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/CNN-PIM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/CNN-PIM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN-PIM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN-PIM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/CNN-PIM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN-PIM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/CNN-PIM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CNN-PIM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/CNN-PIM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/CNN-PIM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CNN-PIM/dpram_rename.v
...
# test_myop-PIM.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox test_myop-PIM.yosys.blif

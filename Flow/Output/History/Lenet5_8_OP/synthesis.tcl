...
# lenet5_8op.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug lenet5_8op.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches lenet5_8op.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/Lenet5_8_OP/dpram_rename.v
...
# lenet5_8op.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox lenet5_8op.yosys.blif

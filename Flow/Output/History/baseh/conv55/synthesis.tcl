...
# conv55_6bit.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug conv55_6bit.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches conv55_6bit.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/baseh/conv55/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/baseh/conv55/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/baseh/conv55/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/baseh/conv55/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/baseh/conv55/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/baseh/conv55/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/baseh/conv55/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/baseh/conv55/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/baseh/conv55/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/baseh/conv55/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/baseh/conv55/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/baseh/conv55/dpram_rename.v
...
# conv55_6bit.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox conv55_6bit.yosys.blif

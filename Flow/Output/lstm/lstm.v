...
//FORGET GATE
  vecmat_add #(`varraysize,`INPUT_DEPTH, `uarraysize) vecmat_add_OP_1(.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wf_in), .data_h(h_in), .W_h(Uf_in), .data_out_x(macout_fx), .data_out_h(macout_fh));
...
//INPUT GATE
  vecmat_add #(`varraysize,`INPUT_DEPTH, `uarraysize) vecmat_add_OP_2(.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wi_in), .data_h(h_in), .W_h(Ui_in), .data_out_x(macout_ix), .data_out_h(macout_ih));
...
//OUTPUT GATE
  vecmat_add #(`varraysize,`INPUT_DEPTH, `uarraysize) vecmat_add_OP_3(.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wo_in), .data_h(h_in), .W_h(Uo_in), .data_out_x(macout_ox), .data_out_h(macout_oh));
...
//CELL STATE GATE
  vecmat_add #(`varraysize,`INPUT_DEPTH, `uarraysize) vecmat_add_OP_4(.clk(clk), .reset(rst), .data_x(x_in), .W_x(Wc_in), .data_h(h_in), .W_h(Uc_in), .data_out_x(macout_cx), .data_out_h(macout_ch));
...
(
	...
	wire [varraysize-1:0] mulout_x;
	wire [uarraysize-1:0] mulout_h;
	vecmat_mul_x #(`varraysize,`INPUT_DEPTH) f_gatex(.clk(clk),.reset(rst),.data(x_in),.W(Wf_in),.tmp(mulout_x));
	vecmat_add_x #(`varraysize,`INPUT_DEPTH) f_gateaddx(.clk(clk),.reset(rst),.mulout(mulout_x),.data_out(data_out_x));

...
# CNN48_M_8.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug CNN48_M_8.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches CNN48_M_8.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CNN48-55/CNN48-55-8-CLB/dpram_rename.v
...
# CNN48_M_8.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox CNN48_M_8.yosys.blif

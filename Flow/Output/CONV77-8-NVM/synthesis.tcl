...
# conv77_8bit_DSP.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug conv77_8bit_DSP.v
	...
	read_systemverilog -debug conv77_8bit_DSP.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches conv77_8bit_DSP.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/CONV77-8-NVM/dpram_rename.v
...
# conv77_8bit_DSP.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox conv77_8bit_DSP.yosys.blif

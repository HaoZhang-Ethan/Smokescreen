...
# rom_params_bram.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug rom_params_bram.v
	...
	read_systemverilog -debug rom_params_bram.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches rom_params_bram.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_D/dpram_rename.v
...
# rom_params_bram.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox rom_params_bram.yosys.blif

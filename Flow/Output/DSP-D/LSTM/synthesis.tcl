...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/LSTM/dpram_rename.v

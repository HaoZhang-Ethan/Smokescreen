...
# control.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug control.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches control.v
...
read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/arch_dsps.v
...
techmap -map /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/single_port_ram.v

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/memory_pim.v

#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/dual_port_ram.v
...
#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/spram_rename.v

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/pimram_rename.v

#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/control/dpram_rename.v
...
# control.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox control.yosys.blif

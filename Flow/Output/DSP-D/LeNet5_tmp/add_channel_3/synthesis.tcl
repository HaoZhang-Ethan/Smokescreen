...
# add_channel_3.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug add_channel_3.v
	...
	read_systemverilog -debug add_channel_3.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches add_channel_3.v
...
read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/arch_dsps.v
...
techmap -map /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/single_port_ram.v

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/memory_pim.v

#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/dual_port_ram.v
...
#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/spram_rename.v

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/pimram_rename.v

#(/home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /home/zolid/Project/Smokescreen/Flow/Output/DSP-D/LeNet5_tmp/add_channel_3/dpram_rename.v
...
# add_channel_3.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox add_channel_3.yosys.blif

...
# tpu_like.small.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug tpu_like.small.v
	...
	read_systemverilog -debug tpu_like.small.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches tpu_like.small.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/DSP-D/TPU_SMALL/dpram_rename.v
...
# tpu_like.small.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox tpu_like.small.yosys.blif

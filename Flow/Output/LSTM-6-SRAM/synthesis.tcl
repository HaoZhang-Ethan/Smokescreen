...
# lstm6_DSP.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug lstm6_DSP.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches lstm6_DSP.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/LSTM-6-SRAM/dpram_rename.v
...
# lstm6_DSP.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox lstm6_DSP.yosys.blif

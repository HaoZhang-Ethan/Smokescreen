...
# mkDelayWorker32B.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_uhdm -debug mkDelayWorker32B.v
	...
	read_systemverilog -debug mkDelayWorker32B.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/mkDelayWorker32B/dpram_rename.v
...
# mkDelayWorker32B.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox mkDelayWorker32B.yosys.blif

...
# LU32PEEng.v (input circuit) is replaced with filename by the run_vtr_flow script
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug LU32PEEng.v

} elseif {$env(PARSER) == "yosys" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches LU32PEEng.v
...
read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/arch_dsps.v
...
techmap -map /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/yosys_models.v */t:\$mul */t:\$mem */t:\$sub */t:\$add
...
#(/root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/single_port_ram.v) will be replaced by single_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/single_port_ram.v

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/memory_pim.v

#(/root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/dual_port_ram.v) will be replaced by dual_port_ram.v by python script

read_verilog -lib /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/dual_port_ram.v
...
#(/root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/spram_rename.v) will be replaced by spram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/spram_rename.v

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/pimram_rename.v

#(/root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/dpram_rename.v) will be replaced by dpram_rename.v by python script

read_verilog /root/Project/Smokescreen/Flow/Output/pimnvm/LU32PEEng/dpram_rename.v
...
# LU32PEEng.yosys.blif will be replaced by run_vtr_flow.pl

write_blif -true + vcc -false + gnd -undef + unconn -blackbox LU32PEEng.yosys.blif
